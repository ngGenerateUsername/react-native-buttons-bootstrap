...
|btnStyle    | string enum  "primary",<br>"secondary","success","danger","warning",<br>"info","outlinePrimary","outlineSecondary","outlineSuccess","outlineDanger","outlineWarning" ,"outlineInfo" | null      |
|btnRadius   | number       | 4             |
